...
display('  ');
command='..\..\bin\AeroDyn_Driver_Win32 Doman_MHK_driver.dvr' ;   % Runs the AeroDyn driver
...
for i=1:NumCases
    fid = fopen( ['Doman_MHK_driver.' num2str(i) '.out'] );   %Open the output files in a loop depending on number of cases
